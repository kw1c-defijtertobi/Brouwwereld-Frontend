    ...
    <div class="cart">
        <div class="product-container">
            <div class="product-row">
                ...
                <p>Hertog Jan <span>Lentebock</span></p>
            ...
            <div class="product-row">
                ...
                <p>Hertog Jan <span>Bockbier</span></p>
                <div class="total-product-price">
                    <p>€7,80</p>
                </div>
            </div>
            <div class="product-row">
                ...
                <p>Leffe <span>Tripel-Tripel</span></p>
                <div class="total-product-price">
                    <p>€12.60</p>
                </div>
            </div>
        ...
        <div class="calc-container">
            <div class="calc-text">
                <div class="calc-text-row">
                    ...
                    <p class="calc-text-price">21.98</p>
                </div>
                <div class="calc-text-row">
                    <p class="calc-text-text">Statiegeld</p>
                    <p class="calc-text-price">2.60</p>
                </div>
                <div class="calc-text-row">
                    <p class="calc-text-text">Totaal</p>
                    <p class="calc-text-price">24.58</p>
                </div>
                <div class="calc-text-row">
                    <p class="calc-text-text">BTW</p>
                    <p class="calc-text-price">1.67</p>
                </div>
                ...
                <div class="cart-promotion-text">
                    ...
                    <p><span style="color:green;">Gratis</span> bezorging vanaf € 50,-</p>
                </div>
            </div>
        </div>
    </div>
